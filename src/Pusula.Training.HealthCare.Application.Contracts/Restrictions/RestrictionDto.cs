...
{
    public virtual MedicalServiceDto MedicalService { get; protected set; }
    public virtual Guid MedicalServiceId { get; protected set; }
    public virtual DepartmentDto Department { get; protected set; }
    public virtual Guid DepartmentId { get; protected set; }
    public virtual DoctorDto Doctor { get; protected set; }
