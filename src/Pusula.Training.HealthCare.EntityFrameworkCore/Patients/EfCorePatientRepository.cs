    ...
    : EfCoreRepository<HealthCareDbContext, Patient, Guid>(dbContextProvider), IPatientRepository
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        query = ApplyFilter(query, filterText, firstName, lastName, birthDateMin, birthDateMax, identityNumber,
            emailAddress, mobilePhoneNumber, homePhoneNumber, genderMin, genderMax);
    ...
    public virtual async Task<List<Patient>> GetListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        var query = ApplyFilter((await GetQueryableAsync()), filterText, firstName, lastName, birthDateMin,
            birthDateMax, identityNumber, emailAddress, mobilePhoneNumber, homePhoneNumber, genderMin, genderMax);
    ...
    public virtual async Task<long> GetCountAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        var query = ApplyFilter((await GetDbSetAsync()), filterText, firstName, lastName, birthDateMin, birthDateMax,
            identityNumber, emailAddress, mobilePhoneNumber, homePhoneNumber, genderMin, genderMax);
