    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    CodeNumber = table.Column<string>(type: "character varying(7)", maxLength: 7, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppIcds", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverageAmount = table.Column<decimal>(type: "numeric", nullable: true),
                    StartDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    EndDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    InsuranceCompanyName = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MobilePhoneNumber = table.Column<string>(type: "character varying(15)", maxLength: 15, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TitleName = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppDoctors_AppCities_CityId",
                        column: x => x.CityId,
                        principalTable: "AppCities",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppDoctors_AppDistricts_DistrictId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppMedicalStaff", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppMedicalStaff_AppCities_CityId",
                        column: x => x.CityId,
                        principalTable: "AppCities",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppMedicalStaff_AppDepartments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "AppDepartments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppMedicalStaff_AppDistricts_DistrictId",
                        column: x => x.DistrictId,
                        principalTable: "AppDistricts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppDoctorLeaves", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppBloodTestCategories", x => new { x.BloodTestId, x.TestCategoryId });
                    table.ForeignKey(
                        name: "FK_AppBloodTestCategories_AppBloodTests_BloodTestId",
                        column: x => x.BloodTestId,
                        principalTable: "AppBloodTests",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppBloodTestCategories_AppTestCategories_TestCategoryId",
                        column: x => x.TestCategoryId,
                        principalTable: "AppTestCategories",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppBloodTestReports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppBloodTestReports_AppBloodTests_BloodTestId",
                        column: x => x.BloodTestId,
                        principalTable: "AppBloodTests",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Complaint = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    StartDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    Story = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppExaminations_AppProtocols_ProtocolId",
            ...
            migrationBuilder.CreateTable(
                name: "AppBloodTestReportResults",
                columns: table => new
                {
                    BloodTestReportId = table.Column<Guid>(type: "uuid", nullable: false),
                    BloodTestResultId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppBloodTestReportResults", x => new { x.BloodTestReportId, x.BloodTestResultId });
                    table.ForeignKey(
                        name: "FK_AppBloodTestReportResults_AppBloodTestReports_BloodTestRepo~",
                        column: x => x.BloodTestReportId,
                        principalTable: "AppBloodTestReports",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppBloodTestReportResults_AppBloodTestResults_BloodTestResu~",
                        column: x => x.BloodTestResultId,
                        principalTable: "AppBloodTestResults",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Allergies = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    Medications = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    Habits = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppBackgrounds", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppExaminationIcds", x => new { x.ExaminationId, x.IcdId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    MotherDisease = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    FatherDisease = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    SisterDisease = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    BrotherDisease = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    AreParentsRelated = table.Column<bool>(type: "boolean", nullable: false),
                    ExaminationId = table.Column<Guid>(type: "uuid", nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppBackgrounds_ExaminationId",
                table: "AppBackgrounds",
                column: "ExaminationId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppBloodTestCategories_TestCategoryId",
                table: "AppBloodTestCategories",
                column: "TestCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_AppBloodTestReportResults_BloodTestResultId",
                table: "AppBloodTestReportResults",
                column: "BloodTestResultId");

            migrationBuilder.CreateIndex(
                name: "IX_AppBloodTestReports_BloodTestId",
                table: "AppBloodTestReports",
                column: "BloodTestId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppDoctorLeaves_DoctorId",
                table: "AppDoctorLeaves",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_AppDoctors_CityId",
                table: "AppDoctors",
                column: "CityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppExaminationIcds_IcdId",
                table: "AppExaminationIcds",
                column: "IcdId");

            migrationBuilder.CreateIndex(
                name: "IX_AppExaminations_ProtocolId",
                table: "AppExaminations",
                column: "ProtocolId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppFamilyHistories_ExaminationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppMedicalStaff_DepartmentId",
                table: "AppMedicalStaff",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_AppMedicalStaff_DistrictId",
                table: "AppMedicalStaff",
                column: "DistrictId");
