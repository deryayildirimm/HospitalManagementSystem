...
public partial class DoctorProtocolReports : HealthCareComponentBase
{
    ...
    private GenericGrid<DoctorStatisticDto> _gridRefFirst;
    private GenericGrid<ProtocolPatientDoctorListReportDto> _gridRefSec;
    ...
    public DoctorProtocolReports()
    {
        _gridRefFirst = new GenericGrid<DoctorStatisticDto>();
        _gridRefSec = new GenericGrid<ProtocolPatientDoctorListReportDto>();
    ...
    private void NavigateToDetail(ProtocolPatientDoctorListReportDto patientList)
    {
    ...
    {
        BreadcrumbItems.Add(new Volo.Abp.BlazoriseUI.BreadcrumbItem(L["Protocol-Doctor Statistics"]));
    ...
    {
        new GridColumnDefinition { Field = "DoctorName", HeaderText = "Doctor Name", Width = "200px" },
    ...
    private void SetFiltersSec()
    {
        ...
        SecQuery.Queries.Params.Add("Filter", FilterFirst);
    }
