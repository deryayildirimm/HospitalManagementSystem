...
public class ProtocolPatientDepartmentListAdaptor(IProtocolsAppService protocolsAppService) :DataAdaptor
{
        ...
        string? additionalParam = null)
    {
        try
        {
            ...
            var result = await protocolsAppService.GetPatientsByDepartmentAsync(filter!);
